...
exports.apiKeyLimiter = exports.jobSubmitLimiter = exports.authLimiter = exports.defaultLimiter = void 0;
...
const baseOptions = {
    ...
    handler: (req, _res, next) => {
        ...
        next(new errors_1.TooManyRequestsError('Too many requests — please slow down and try again later'));
    },
    /**
...
exports.defaultLimiter = (0, express_rate_limit_1.default)({
    ...baseOptions,
    windowMs: env_1.env.RATE_LIMIT_WINDOW_MS, // default: 15 minutes (900_000 ms)
    max: env_1.env.RATE_LIMIT_MAX, // default: 100 requests
 ...
 */
exports.jobSubmitLimiter = (0, express_rate_limit_1.default)({
    ...baseOptions,
